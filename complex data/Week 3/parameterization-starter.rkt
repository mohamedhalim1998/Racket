...
;; filter the given list with p 

(check-expect (filter2 positive? empty) empty)
(check-expect (filter2 positive? (list 5)) (list 5))
(check-expect (filter2 positive? (list -2)) empty)
(check-expect (filter2 positive? (list 5 7)) (list 5 7))
(check-expect (filter2 positive? (list 5 -7)) (list 5))
